...
folder_ripe_test = '/app/MANGO/Ripe/Test'
folder_ripe_training = '/app/MANGO/Ripe/Training'
folder_early_ripe_test = '/app/MANGO/Early_Ripe/Test'
folder_early_ripe_training = '/app/MANGO/Early_Ripe/Training'
folder_partially_ripe_test = '/app/MANGO/Partially_Ripe/Test'
folder_partially_ripe_training = '/app/MANGO/Partially_Ripe/Training'
folder_over_ripe_test = '/app/MANGO/over_ripe/Test'  # Adjusted the folder name
folder_over_ripe_training = '/app/MANGO/over_ripe/Training'  # Adjusted the folder name
folder_not_mango_test = '/app/MANGO/not_mango/Test'  # Adjusted the folder name
folder_not_mango_training = '/app/MANGO/not_mango/Training'  # Adjusted the folder name
folder_unripe_test='/app/MANGO/Unripe/Test'
folder_unripe_training='/app/MANGO/Unripe/Training'
...
def upload_predict():
    if request.method == 'POST':
        ...
        if image_file:
            upload_folder = r'C:\Users\hp\PycharmProjects\MANGO-ML67\MANGO-ML\MANGO\upload_folder'  # Specify your desired upload folder
